...
```{r}
dmel.rnaseq.5.57 <- ExpressionSet(assayData = gene.assayData,
...
```{r,eval=FALSE}
usethis::use_data(dmel.rnaseq.5.57,internal = FALSE, overwrite = TRUE)
usethis::use_data(dmel.rnaseq,internal = FALSE, overwrite = TRUE)
```